...
parser.add_argument('--gamma',
                    help='the coefficient of unlikelihood',
                    type=float,
                    default=1)

parser.add_argument('--gamma_crossover_epoch',
                    help='at which epoch to turn on the gamma (the center of sigmoid)',
                    type=float,
                    default=6)

parser.add_argument('--unlike_type',
                    help='lin, log or no',
                    type=str,
                    default='log')

parser.add_argument('--log_bias',
                    help='',
                    type=float,
                    default=0.000000001)
